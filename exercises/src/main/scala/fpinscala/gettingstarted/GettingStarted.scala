...
object PolymorphicFunctions {
  ...
  def addCurry(a: Int): (Int) => Int = (b: Int) => a + b
  type addCurry = (Int) => (Int) => Int
  def addNotCurry(a: Int, b: Int): Int = a + b
  type addNotCurry = (Int, Int) => Int
  def curryAddNotCurry(f: addNotCurry): (Int) => (Int) => (Int) = (a) => (b) => f(a, b)
  def undoAddCurry(f: addCurry): (Int, Int) => Int = (a, b) => f(a)(b)
